    ...
    <>    
      ...
      <div className={classes.detailsDiv} id="reservationDetails">
        ...
        <ul>
          ...
          <li>Created at: {new Date(reservation?.created_at).toLocaleDateString("pl-PL")} {new Date(reservation?.created_at).toLocaleTimeString("pl-PL")}</li>
          <li />
          ...
          <li>One day price: {reservation?.day_price_cents / 100} PLN</li>
          ...
          <li>Total cost: {totalDays * reservation?.day_price_cents / 100 || 0} PLN</li>
        </ul>
